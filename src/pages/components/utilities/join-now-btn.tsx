...
const JoinNowButton = () => {
  return (
    <div>
      <a
        href="#_"
        className="no-underline text-3xl group relative inline-flex items-center justify-start overflow-hidden rounded-full bg-white border-2 border-white px-6 py-3 pt-2 pb-2 pl-10 pr-10 transition-all "
      >
