          ...
          >
                ...
                <div className="radio " style={{ margin: "2rem" }}>
                  <label>
                    <input
                      ...
                      name="optradio"
                    />{" "}
                    Groops! Instant Delivery (24h guaranteed, only available in
                    Greater Montreal at this moment)
                  </label>
                </div>
            ...
            <div style={{ marginLeft: "5rem" }}>
              <div
                ...
                style={{ width: "400px", display: "flex", lineHeight: "3rem" }}
              >
              ...
              <div style={{ paddingBottom: "3rem", paddingTop: "2rem" }}>
                Our deliverers try their best to give you the best services, so
                if you tip them they will be happy :)
              </div>
            </div>
          </div>
          <div
