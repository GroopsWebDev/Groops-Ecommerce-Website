...
const ProductUploadPage = (props: IProps) => {
  ...
  const create_product = api.productApi.createProduct.useMutation();
  ...
  async function onSubmit(data: any) {
    ...
    if (productId == undefined || productId == "") {
      try {
        ...
        // const produce =  await create_product_min.mutateAsync({
        ...
        await create_product_min.mutate({ 
          englishProductName: "english_product_name",
          product_weight: "weight",
          primary_image_url: "image url",
         });
      ...
      try {
        ...
        if (response.status == 200) {
          ...
          Swal.fire({
            title: "Profile",
            text: "Response 200: Product Updated Successfully",
            icon: "success",
            confirmButtonText: "OK",
          });
        }
