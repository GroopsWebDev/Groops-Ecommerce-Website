  ...
  return <div className="flex flex-row p-10 bg-gray-100">
    ...
    <div className="w-1/2 flex flex-row justify-between">
      ...
      <div className="flex flex-col gap-5">
        <h1 className="font-bold text-xl mb-5">Groops</h1>
