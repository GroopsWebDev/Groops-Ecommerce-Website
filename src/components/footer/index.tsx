...
export default function Footer() {
  return (
    <div className="flex flex-row bg-gray-100 p-10">
      <div className="w-1/2">
        <Link href="/">
      ...
      <div className="flex w-1/2 flex-row justify-between">
        <div className="flex flex-col gap-5">
          <h1 className="mb-5 text-xl font-bold text-rose-600">Groops</h1>
        ...
        <div className="flex flex-col gap-5">
          <h1 className="mb-5 text-xl font-bold text-rose-600">Help</h1>
        ...
        <div className="mr-20 flex flex-col gap-5">
          <h1 className="mb-5 text-xl font-bold text-rose-600">Contact</h1>
